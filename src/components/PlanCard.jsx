...
const PlanCard = ({ plan, index }) => {
  ...
  const manejarNavegacion = () => {
    // Redirige a la ruta dinámica configurada en App.js
    ...
    >
      ...
      >
        ...
        <img
          ...
          className={`w-full h-full object-cover transition-all duration-700 group-hover:scale-110 ${cargando ? 'opacity-0' : 'opacity-100'}`}
          alt={plan.nombre}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex justify-between items-center pt-4 border-t border-orange-50">
          ...
          <button 
            onClick={manejarNavegacion} 
            className="bg-orange-500 text-white p-3 rounded-xl shadow-md hover:bg-rose-600 transition-colors duration-300"
            title="Ver detalles de la experiencia"
          >
