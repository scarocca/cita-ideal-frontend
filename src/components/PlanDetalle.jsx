...
// ✅ Mantenemos 'plan' aquí, pero asegúrate de que en App.jsx lo pases igual
const PlanDetalle = ({ plan, onClose }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-full w-full bg-white backdrop-blur-xl relative overflow-hidden rounded-[2.5rem] shadow-2xl">
      
      {/* BOTÓN CERRAR - Subimos Z-index para que siempre sea clicable */}
      <button 
        onClick={onClose} 
        className="absolute top-4 right-4 z-[110] bg-white/90 backdrop-blur-md shadow-lg text-rose-900 hover:bg-rose-600 hover:text-white p-3 rounded-full transition-all duration-300 active:scale-90 border border-orange-100"
      >
